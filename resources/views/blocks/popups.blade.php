...
<div class="popup" id="create-request" style="display:none">
    <form class="form" id="form" action="{{ route('ajax.request') }}" onclick="sendRequest(this, event)">
...
<div class="popup" id="subscribe-success" style="display:none">
    <div class="popup__title">Подписка!</div>
    <div class="popup__text">Вы успешно подписались на рассылку новостей.</div>
</div>
<div class="popup" id="order-success" style="display:none">
    <div class="popup__title">Заказ оформлен!</div>
    <div class="popup__text">Ваш заказ успешно оформлен. Наши менеджеры свяжутся с вами в ближайшее время.</div>
</div>
